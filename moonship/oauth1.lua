...
local string_split, query_string_encode, url_parse, url_build
string_split, query_string_encode, url_parse, url_build = util.string_split, util.query_string_encode, util.url_parse, util.url_build
local sort, concat
do
  local _obj_0 = table
